...
public class ValidatorHelperRequest implements IValidationHelper, StateRestorer {
    ...
    public ValidatorHelperResult validate(final ValidationContext context) {
        ...
        while (parameters.hasMoreElements()) {
            ...
            // Validate parameter
            result = validateParameter(ctx, stateParams, state.getParameter(parameter), stateParams.get(parameter), unauthorizedEditableParameters, hdivParameter, target, parameter);
            if (!result.isValid()) {
                return result;
            }
        }
    ...
    protected final ValidatorHelperResult validateRequestCookies(final ValidationContext context, final String target) {
        ...
        @SuppressWarnings("unchecked") Map<String, SavedCookie> sessionCookies = // TODO cache
        session.getAttribute(// TODO cache
        ...
        for (int i = 0; i < requestCookies.length; i++) {
            ...
            if (!found) {
                ValidatorError error = new ValidatorError(HDIVErrorCodes.INVALID_COOKIE, target, "cookie:" + requestCookies[i].getName(), requestCookies[i].getValue());
                return new ValidatorHelperResult(error);
            }
        }
        return ValidatorHelperResult.VALID;
	 ...
	 * @since HDIV 1.1
	 */
    protected void validateEditableParameter(final String target, final String parameter, final String[] values, final String dataType, final List<ValidatorError> unauthorizedParameters) {
        ...
        if (!result.isValid()) {
            ...
            ValidatorError error = new ValidatorError(HDIVErrorCodes.INVALID_EDITABLE_VALUE, target, parameter, value, null, result.getValidationId());
            unauthorizedParameters.add(error);
        }
    }

    @Deprecated
    protected final ValidatorHelperResult allRequiredParametersReceived(final HttpServletRequest request, final IState state, final String target, final Map<String, String[]> stateParams) {
        throw new UnsupportedOperationException();
    }
	 ...
	 */
    protected ValidatorHelperResult allRequiredParametersReceived(final RequestContextHolder request, final IState state, final String target, final Map<String, String[]> stateParams) {
    ...
    @Deprecated
    protected final ValidatorHelperResult validateMissingParameters(final HttpServletRequest request, final IState state, final String target, final Map<String, String[]> stateParams, final List<String> missingParameters) {
        throw new UnsupportedOperationException();
    }
	 ...
	 */
    protected ValidatorHelperResult validateMissingParameters(final RequestContextHolder request, final IState state, final String target, final Map<String, String[]> stateParams, final List<String> missingParameters) {
    ...
    protected ValidatorHelperResult validateParameter(final RequestContextHolder request, final Map<String, String[]> stateParams, final IParameter stateParameter, final String[] actionParamValues, final List<ValidatorError> unauthorizedEditableParameters, final String hdivParameter, final String target, final String parameter) {
        ...
        if (stateParameter == null && actionParamValues == null) {
            ...
            return validateExtraParameter(request, stateParams, stateParameter, actionParamValues, unauthorizedEditableParameters, hdivParameter, target, parameter);
        }
    ...
    @Deprecated
    protected final ValidatorHelperResult restoreState(final String hdivParameter, final String hdivState, final ValidationContext context) {
    ...
    @Deprecated
    protected final ValidatorHelperResult restoreState(final String hdivParameter, final HttpServletRequest request, final String target, final String requestState) {
        return restoreState(hdivParameter, HDIVUtil.getRequestContext(request), target, requestState);
    }

    @Deprecated
    protected final ValidatorHelperResult restoreState(final String hdivParameter, final RequestContextHolder context, final String target, final String requestState) {
        throw new UnsupportedOperationException();
    }
    ...
    public final ValidatorHelperResult restoreState(final ValidationContext context, String requestState) {
        if (requestState == null) {
            ValidatorError error = new ValidatorError(HDIVErrorCodes.HDIV_PARAMETER_DOES_NOT_EXIST, context.getRequestedTarget(), context.getRequestContext().getHdivParameterName());
            return new ValidatorHelperResult(error);
        }
        // requestState
        ...
        try {
            ...
            if (!validateHDIVSuffix(ctx, requestState, state)) {
                ValidatorError error = new ValidatorError(HDIVErrorCodes.INVALID_HDIV_PARAMETER_VALUE, context.getRequestedTarget(), context.getRequestContext().getHdivParameterName(), requestState);
                return new ValidatorHelperResult(error);
            }
    ...
    @Deprecated
    protected final ValidatorHelperResult validateParameterValues(final HttpServletRequest request, final String target, final IParameter stateParameter, final String[] actionParamValues, final String parameter, final String[] values) {
        throw new UnsupportedOperationException();
    }
	 ...
	 */
    protected ValidatorHelperResult validateParameterValues(final RequestContextHolder request, final String target, final IParameter stateParameter, final String[] actionParamValues, final String parameter, final String[] values) {
        try {
            // values received.
    ...
    @Deprecated
    protected final ValidatorHelperResult hasRepeatedOrInvalidValues(final HttpServletRequest request, final String target, final String parameter, final String[] values, final List<String> stateValues) {
        throw new UnsupportedOperationException();
    }

    @Deprecated
    protected final ValidatorHelperResult hasRepeatedOrInvalidValues(final RequestContextHolder request, final String target, final String parameter, final String[] values, final List<String> stateValues) {
	 ...
	 */
    protected final ValidatorHelperResult hasRepeatedOrInvalidValues(final RequestContextHolder request, final String target, final String parameter, final String[] values, final List<String> stateValues, final IParameter stateParameter) {
    ...
    @Deprecated
    protected final ValidatorHelperResult hasConfidentialIncorrectValues(final HttpServletRequest request, final String target, final String parameter, final String[] values, final List<String> stateValues) {
        throw new UnsupportedOperationException();
    }

    @Deprecated
    protected final ValidatorHelperResult hasConfidentialIncorrectValues(final RequestContextHolder request, final String target, final String parameter, final String[] values, final List<String> stateValues) {
	 ...
	 */
    protected final ValidatorHelperResult hasConfidentialIncorrectValues(final RequestContextHolder request, final String target, final String parameter, final String[] values, final List<String> stateValues, final IParameter stateParameter) {
        Set<String> receivedValues = new HashSet<String>();
        for (int i = 0; i < values.length; i++) {
            if (hdivConfig.isParameterWithoutConfidentiality(request, parameter) || stateParameter != null && HDIVUtil.isNonConfidentialType(stateParameter.getEditableDataType())) {
                return ValidatorHelperResult.VALID;
            }
	 ...
	 * @return True If repeated or no valid values have been received for the parameter <code>parameter</code>.
	 */
    protected ValidatorHelperResult hasNonConfidentialIncorrectValues(final String target, final String parameter, final String[] values, final List<String> tempStateValues) {
        Set<String> receivedValues = new HashSet<String>();
        for (int i = 0; i < values.length; i++) {
            ...
            if (!exists) {
                ...
                ValidatorError error = new ValidatorError(HDIVErrorCodes.INVALID_PARAMETER_VALUE, target, parameter, values[i], originalValue);
                return new ValidatorHelperResult(error);
            }
            receivedValues.add(values[i]);
        }
    ...
    @Deprecated
    protected final ValidatorHelperResult validateReceivedValuesInState(final HttpServletRequest request, final String target, final IParameter stateParameter, final String[] actionParamValues, final String parameter, final String[] values) {
        throw new UnsupportedOperationException();
    }
	 ...
	 */
    protected ValidatorHelperResult validateReceivedValuesInState(final RequestContextHolder request, final String target, final IParameter stateParameter, final String[] actionParamValues, final String parameter, final String[] values) {
